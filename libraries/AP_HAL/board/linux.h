...
#define PROBE_MAG_IMU_I2C(driver, imudev, bus, addr, args ...) ADD_BACKEND(DRIVER_ ##driver, AP_Compass_ ## driver::probe_ ## imudev(GET_I2C_DEVICE(bus,addr),##args))
    ...
    * 240x240 crop rescaled to 64x64 */
    ...
    #define HAL_GPIO_A_LED_PIN 20
    #define HAL_GPIO_B_LED_PIN 23
    #define HAL_GPIO_C_LED_PIN 26
    #define HAL_GPIO_LED_ON    HIGH
    #define HAL_GPIO_LED_OFF   LOW
    #define HAL_BUZZER_PWM_CHIP 2
    #define HAL_BUZZER_PWM_CHANNEL 0
    #define HAL_BUZZER_PWM_FREQ_HZ 2730
    #define HAL_INS_PROBE_LIST PROBE_IMU_I2C(Invensensev2, 2, 0x68, ROTATION_NONE)
    #define HAL_BARO_PROBE_LIST PROBE_BARO_I2C(BMP280, 2, 0x76)
    #define HAL_COMPASS_ICM20948_I2C_ADDR 0x68
    //#define HAL_MAG_PROBE_LIST PROBE_MAG_IMU_I2C(AK09916, ICM20948, 2, 0x0c, false, ROTATION_NONE)
    //#define HAL_MAG_PROBE_LIST ADD_BACKEND(DRIVER_AK09916, AP_Compass_AK09916::probe_ICM20948(GET_I2C_DEVICE(2,0x0C), GET_I2C_DEVICE(2,0x68), true, ROTATION_NONE))
    #define HAL_BATT_MONITOR_DEFAULT AP_BattMonitor_Params::BattMonitor_TYPE_ANALOG_VOLTAGE_AND_CURRENT
    #define HAL_PROBE_EXTERNAL_I2C_COMPASSES
    #define HAL_COMPASS_DEFAULT HAL_COMPASS_NONE
    //#define HAL_OPTFLOW_PX4FLOW_I2C_BUS 1
    //#define HAL_RANGEFINDER_LIGHTWARE_I2C_BUS 1
